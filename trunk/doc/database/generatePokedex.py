...
def main(types, megatypes, caracs, datatalents):
    ...
    for type_name in types:
        ...
        name = type_name[2].strip()
        number = int(type_name[0][1:])
        type1, type2 = type_name[4].split("/")
        
        type1 = type_matching[type1]
        type2 = type_matching[type2]
        
        result_list[name] = {"name": name, "number": number, "type1": type1, "type2": type2}
    
    
    for type_name in megatypes.split("\n"):
        type_name = type_name.split("\t")
        name = type_name[1].strip()
        number = int(type_name[0])
        type1, type2 = type_name[2].split("/")
        
        type1 = type_matching[type1]
        type2 = type_matching[type2]
        
        abilities = [type_name[3].strip().replace("-", "_").replace(" ", "_").replace(".", "").upper()]
        
        result_list[name] = {"name": name, "number": number, "type1": type1, "type2": type2, "abilities": abilities}
    
    
    for name, abilities in datatalents.items():
        abilities = [ability.strip().replace("-", "_").replace(" ", "_").replace(".", "").upper() for ability in abilities]
        result_list[name].update({"abilities":abilities})
    ...
    for carac in caracs.split("\n"):
        ...
        attack = int(carac[4])
        defense = int(carac[5])
        sp_attack = int(carac[6])
        sp_defense = int(carac[7])
        speed = int(carac[8])
        
        if name.find("(") == -1:
            result_list[name].update({"life": life, "attack": attack, "defense": defense, "sp_attack": sp_attack, "sp_defense": sp_defense, "speed": speed})
        else:
            for baseName, p in result_list.items():
                if p["number"] == number and baseName.find("(") == -1:
                    break
            result_list[name] = result_list[baseName].copy()
            result_list[name].update({"name": name, "life": life, "attack": attack, "defense": defense, "sp_attack": sp_attack, "sp_defense": sp_defense, "speed": speed})
            toRemove[baseName] = True
    
    for name, v in toRemove.items():
        del result_list[name]
#     print result_list
#     return
     
#     text = ""
#     for name, p in result_list.items():
#         text += """
# 
#         abilities = new ArrayList<Ability>(){{"""
#         
#         for ability in p["abilities"]:
#             text += "this.add(Ability.{});".format(ability)
#         
#         p["name"] = toId(p["name"])
#         
#         text += """}}}};
#         perName.put(ctx.getString(R.string.name_{name}), new Pokemon(ctx.getString(R.string.name_{name}), {number}, 
#                     {index}, Type.{type1}, Type.{type2}, abilities, {life}, {attack}, {defense}, {sp_attack}, {sp_defense}, {speed}));""".format(**p)
#     print text

    for name, p in result_list.items():
        p["name"] = "R.string.name_{}".format(p["number"])
...
ability_mapping = {
    "ABSENTEISME": "TRUANT",
    "ABSORB_EAU": "WATER_ABSORB",
    "ABSORB_VOLT": "VOLT_ABSORB",
    "AGITATION": "HUSTLE",
    "AIR_LOCK": "AIR_LOCK",
    "ANTI_BRUIT": "SOUNDPROOF",
    "ARMUMAGMA": "MAGMA_ARMOR",
    "ARMURBASTON": "BATTLE_ARMOR",
    "ATTENTION": "INNER_FOCUS",
    "BENET": "OBLIVIOUS",
    "BOOM_FINAL": "AFTERMATH",
    "BRASIER": "BLAZE",
    "CACOPHONIE": "CACOPHONY",
    "CALQUE": "TRACE",
    "CHANCEUX": "SUPER_LUCK",
    "CHLOROPHYLE": "CHLOROPHYLL",
    "CIEL_GRIS": "CLOUD_NINE",
    "COLOFORCE": "HUGE_POWER",
    "COQUE_ARMURE": "SHELL_ARMOR",
    "CORPS_ARDENT": "FLAME_BODY",
    "CORPS_SAIN": "CLEAR_BODY",
    "CRACHIN": "DRIZZLE",
    "CRAN": "GUTS",
    "CUVETTE": "RAIN_DISH",
    "DEGUISEMENT": "COLOR_CHANGE",
    "ECAILLE_SPE": "MARVEL_SCALE",
    "ECHAUFFEMENT": "LIMBER",
    "ECRAN_FUMEE": "WHITE_SMOKE",
    "ECRAN_POUDRE": "SHIELD_DUST",
    "ENGRAIS": "OVERGROW",
    "ESPRIT_VITAL": "VITAL_SPIRIT",
    "ESSAIM": "SWARM",
    "FERMETE": "STURDY",
    "FORCE_PURE": "PURE_POWER",
    "FUITE": "RUN_AWAY",
    "GARDE_MYSTIK": "WONDER_GUARD",
    "GLISSADE": "SWIFT_SWIM",
    "GLUE": "STICKY_HOLD",
    "HYPER_CUTTER": "HYPER_CUTTER",
    "IGNIFU_VOILE": "WATER_VEIL",
    "INSOMNIA": "INSOMNIA",
    "INTIMIDATION": "INTIMIDATE",
    "ISOGRAISSE": "THICK_FAT",
    "JOLI_SOURIRE": "CUTE_CHARM",
    "LEVITATION": "LEVITATE",
    "LUMIATTIRANCE": "ILLUMINATE",
    "MAGNEPIEGE": "MAGNET_PULL",
    "MARQUE_OMBRE": "SHADOW_TAG",
    "MATINAL": "EARLY_BIRD",
    "MEDIC_NATURE": "NATURAL_CURE",
    "METEO": "FORECAST",
    "MINUS": "MINUS",
    "MOITEUR": "DAMP",
    "MUE": "SHED_SKIN",
    "OEIL_COMPOSE": "COMPOUNDEYE",
    "PARATONNERRE": "LIGHTNINGROD",
    "PEAU_DURE": "ROUGH_SKIN",
    "PIEGE": "ARENA_TRAP",
    "PLUS": "PLUS",
    "POINT_POISON": "POISON_POINT",
    "POSE_SPORE": "EFFECT_SPORE",
    "PRESSION": "PRESSURE",
    "PUANTEUR": "STENCH",
    "RAMASSAGE": "PICKUP",
    "REGARD_VIF": "KEEN_EYE",
    "SABLE_VOLANT": "SAND_STREAM",
    "SECHERESSE": "DROUGHT",
    "SERENITE": "SERENE_GRACE",
    "STATIK": "STATIC",
    "SUINTEMENT": "LIQUID_OOZE",
    "SYNCHRO": "SYNCHRONIZE",
    "TEMPO_PERSO": "OWN_TEMPO",
    "TETE_DE_ROC": "ROCK_HEAD",
    "TORCHE": "FLASH_FIRE",
    "TORRENT": "TORRENT",
    "TURBO": "SPEED_BOOST",
    "VACCIN": "IMMUNITY",
    "VENTOUSE": "SUCTION_CUPS",
    "VOILE_SABLE": "SAND_VEIL",
    "ADAPTABILITE": "ADAPTABILITY",
    "ALERTE_NEIGE": "SNOW_WARNING",
    "ANNULE_GARDE": "NO_GUARD",
    "ANTICIPATION": "ANTICIPATION",
    "BRISE_MOULE": "MOLD_BREAKER",
    "CHERCHE_MIEL": "HONEY_GATHER",
    "COLERIQUE": "ANGER_POINT",
    "CORPS_GEL": "ICE_BODY",
    "DEBUT_CALME": "SLOW_START",
    "DELESTAGE": "UNBURDEN",
    "DON_FLORAL": "FLOWER_GIFT",
    "FEUIL_GARDE": "LEAF_GUARD",
    "FILTRE": "FILTER",
    "FORCE_SOLEIL": "SOLAR_POWER",
    "FOUILLE": "FRISK",
    "FREIN": "STALL",
    "GARDE_MAGIK": "MAGIC_GUARD",
    ...
    "INCONSCIENT": "UNAWARE",
    "LAVABO": "STORM_DRAIN",
    "LENTITEINTEE": "TINTED_LENS",
    "MALADRESSE": "KLUTZ",
    "MAUVAIS_REVE": "BAD_DREAMS",
    "MOTORISE": "MOTOR_DRIVE",
    "MULTI_COUPS": "SKILL_LINK",
    "MULTITYPE": "MULTITYPE",
    "NORMALISE": "NORMALIZE",
    "PEAU_SECHE": "DRY_SKIN",
    "PIED_CONFUS": "TANGLED_FEET",
    "PIED_VELOCE": "QUICK_FEET",
    "POING_DE_FER": "IRON_FIST",
    "PREDICTION": "FOREWARN",
    "QUERELLEUR": "SCRAPPY",
    "RIDEAU_NEIGE": "SNOW_CLOAK",
    "RIVALITE": "RIVALRY",
    "SIMPLE": "SIMPLE",
    "SNIPER": "SNIPER",
    "SOIN_POISON": "POISON_HEAL",
    "SOLIDE_ROC": "SOLID_ROCK",
    "TECHNICIEN": "TECHNICIAN",
    "TELECHARGE": "DOWNLOAD",
    "TEMERAIRE": "RECKLESS",
    "ACHARNE": "DEFIANT",
    "ANALYSTE": "ANALYTIC",
    "ARMUROUILLEE": "WEAK_ARMOR",
    "BAIGNE_SABLE": "SAND_RUSH",
    "COEUR_DE_COQ": "BIG_PECKS",
    "COEUR_NOBLE": "JUSTIFIED",
    "COEUR_SOIN": "HEALER",
    "CONTESTATION": "CONTRARY",
    "CORPS_MAUDIT": "CURSED_BODY",
    "DEFAITISTE": "DEFEATIST",
    "ENVELOCAPE": "OVERCOAT",
    "EPINE_DE_FER": "IRON_BARBS",
    "FARCEUR": "PRANKSTER",
    "FORCE_SABLE": "SAND_FORCE",
    "GARDE_AMIE": "FRIEND_GUARD",
    "HEAVY_METAL": "HEAVY_METAL",
    "HERBIVORE": "SAP_SIPPER",
    "ILLUSION": "ILLUSION",
    "IMPOSTEUR": "IMPOSTER",
    "IMPUDENCE": "MOXIE",
    ...
    "LUNATIQUE": "MOODY",
    "MIROIR_MAGIK": "MAGIC_BOUNCE",
    "MODE_TRANSE": "ZEN_MODE",
    "MOMIE": "MUMMY",
    "MULTIECAILLE": "MULTISCALE",
    "PEAU_MIRACLE": "WONDER_SKIN",
    "PHOBIQUE": "RATTLED",
    "PICKPOCKET": "PICKPOCKET",
    "RAGE_BRELURE": "FLARE_BOOST",
    "RAGE_POISON": "TOXIC_BOOST",
    "RECOLTE": "HARVEST",
    "REGE_FORCE": "REGENERATOR",
    "SANS_LIMITE": "SHEER_FORCE",
    "TELEPATHE": "TELEPATHY",
    "TENSION": "UNNERVE",
    "TERA_VOLTAGE": "TERAVOLT",
    "TOXITOUCHE": "POISON_TOUCH",
    "TURBOBRASIER": "TURBOBLAZE",
    "VICTORIEUX": "VICTORY_STAR",
    "AILES_BOURRASQUE": "GALE_WINGS",
    "AMOUR_FILIAL": "PARENTAL_BOND",
    "AROMA_VOILE": "AROMA_VEIL",
    "AURA_FEERIQUE": "FAIRY_AURA",
    "AURA_INVERSEE": "AURA_BREAK",
    "AURA_TENEBREUSE": "DARK_AURA",
    "BAJOUES": "CHEEK_POUCH",
    "BATTANT": "COMPETITIVE",
    "DECLIC_TACTIQUE": "STANCE_CHANGE",
    "FLORA_VOILE": "FLOWER_VEIL",
    "GLUCO_VOILE": "SWEET_VEIL",
    "GRIFFE_DURE": "TOUGH_CLAWS",
    "MAGICIEN": "MAGICIAN",
    "MEGA_BLASTER": "MEGA_LAUNCHER",
    "PARE_BALLES": "BULLETPROOF",
    "PEAU_CELESTE": "AERILATE",
    "PEAU_FEERIQUE": "PIXILATE",
    "PEAU_GELEE": "REFRIGERATE",
    "POISSEUX": "GOOEY",
    "PROGNATHE": "STRONG_JAW",
    "PROTEEN": "PROTEAN",
    "SYMBIOSE": "SYMBIOSIS",
    "TOISON_EPAISSE": "FUR_COAT",
    "TOISON_HERBUE": "GRASS_PELT",
}
