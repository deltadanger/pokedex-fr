...
public class PokemonList {
	...
	public static void initialize() {
	    ...
	    perName.get("{name}").evolutions = new EvolutionLink(perName.get("{name}"), new HashMap<String, EvolutionLink>(){{this.put("{evolution}", new EvolutionLink(perName.get("{name}"), null));}}); 
//	    new EvolutionLink(perName.get("{name}"), "{evolution}", new EvolutionLink(perName.get("{name}"), "{evolution}", new EvolutionLink(perName.get("{name}"), "{evolution}", null)));
        
	    perName.get("{name}").catchRate = 0;
        perName.get("{name}").weight = "";
        perName.get("{name}").hatch = "";
        perName.get("{name}").gender = "";
        perName.get("{name}").ev = "";
        perName.get("{name}").eggGroup= "";
        perName.get("{name}").size = "";
